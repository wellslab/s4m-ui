    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-dropdown text="Atlases" variant="dark" class="ml-4">
          ...
          <b-dropdown-item v-if="serverEnv!='prod'" to="/atlas/activation">Integrated activation atlas</b-dropdown-item>
        ...
        <b-dropdown text="Genes" variant="dark" class="ml-4">
          ...
          <b-dropdown-item to="/genes/genetosamples">From gene to samples</b-dropdown-item>
        </b-dropdown>
      </b-navbar-nav>
    </b-collapse>
  </b-container>
